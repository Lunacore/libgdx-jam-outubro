...
public class Platform extends TiledImageObject{
	...
	public Platform(ObjectInfo info, MapProperties properties) {
		...
		tamanho = get("tamanho", Boolean.class, false);
	...
	public void changeSize(Rectangle2D oldRect, Rectangle2D newRect) {
		//Tamanho
				if(tamanho) {
	...
	public void changePosition(Rectangle2D oldRect, Rectangle2D newRect) {
		//Posição
				float relativeX =
