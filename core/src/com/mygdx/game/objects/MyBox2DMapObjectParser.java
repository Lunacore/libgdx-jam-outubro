 ...
 *  Just create a new {@link MyBox2DMapObjectParser} and call {@link #load(World, MapLayer)} to load all compatible objects (defined by the the {@link #aliases}) into your {@link World}.<br>
 *  <br>
 ...
 *  <br>
 *  For more information read the <a href="http://bitbucket.org/dermetfan/libgdx-utils/wiki/MyBox2DMapObjectParser">wiki</a>.
 *  @author dermetfan */
public class MyBox2DMapObjectParser {
	...
	public interface Listener {
		...
		/** @param parser the {@link MyBox2DMapObjectParser} instance that is going to {@link MyBox2DMapObjectParser#load(World, Map) process} a map */
		public void init(MyBox2DMapObjectParser parser);
	...
	private ObjectMap<Integer, Body> bodies_id = new ObjectMap<Integer, Body>();
	...
	/** creates a new {@link MyBox2DMapObjectParser} with the default {@link Aliases} */
	public MyBox2DMapObjectParser() {}

	/** creates a new {@link MyBox2DMapObjectParser} using the given {@link Aliases}
	 *  @param aliases the {@link #aliases} to use */
	public MyBox2DMapObjectParser(Aliases aliases) {
		this.aliases = aliases;
	}

	/** creates a new {@link MyBox2DMapObjectParser} using the given {@link Listener}
	 *  @param listener the {@link #listener} to use */
	public MyBox2DMapObjectParser(Listener listener) {
		this.listener = listener;
	}

	/** creates a new {@link MyBox2DMapObjectParser} using the given {@link Aliases} and {@link Listener}
	 *  @param aliases the {@link #aliases}
	 *  @param listener the {@link #listener} */
	public MyBox2DMapObjectParser(Aliases aliases, Listener listener) {
		this.aliases = aliases;
		this.listener = listener;
	}

	/** creates a new {@link MyBox2DMapObjectParser} using the given {@link Aliases}, {@link #tileWidth} and {@link #tileHeight}
	 *  @param aliases the {@link #aliases}
	 *  @param tileWidth the {@link #tileWidth}
	 *  @param tileHeight the {@link #tileHeight} */
	public MyBox2DMapObjectParser(Aliases aliases, float tileWidth, float tileHeight) {
		this.aliases = aliases;
		this.tileWidth = tileWidth;
		this.tileHeight = tileHeight;
	}

	/** creates a new {@link MyBox2DMapObjectParser} using the given {@link Listener}, {@link #tileWidth} and {@link #tileHeight}
	 *  @param listener the {@link #listener}
	 *  @param tileWidth the {@link #tileWidth}
	 *  @param tileHeight the {@link #tileHeight} */
	public MyBox2DMapObjectParser(Listener listener, float tileWidth, float tileHeight) {
		this.listener = listener;
		this.tileWidth = tileWidth;
		this.tileHeight = tileHeight;
	}

	/** creates a new {@link MyBox2DMapObjectParser} using the given {@link Listener}, {@link Aliases}, {@link #tileWidth} and {@link #tileHeight}
	 *  @param aliases the {@link #aliases}
	 *  @param listener the {@link #listener}
	 *  @param tileWidth the {@link #tileWidth}
	 *  @param tileHeight the {@link #tileHeight} */
	public MyBox2DMapObjectParser(Aliases aliases, Listener listener, float tileWidth, float tileHeight) {
		this.aliases = aliases;
		this.listener = listener;
		this.tileWidth = tileWidth;
		this.tileHeight = tileHeight;
	...
	/** creates a new {@link MyBox2DMapObjectParser} using the given {@link #unitScale unitScale} and sets {@link #ignoreMapUnitScale} to true
	 *  @param unitScale the {@link #unitScale unitScale} to use */
	public MyBox2DMapObjectParser(float unitScale) {
		this.unitScale = unitScale;
	}

	/** creates a new {@link MyBox2DMapObjectParser} using the given {@link #unitScale}, {@link #tileWidth}, {@link #tileHeight} and sets {@link #ignoreMapUnitScale} to true
	...
	public MyBox2DMapObjectParser(float unitScale, float tileWidth, float tileHeight) {
		this.unitScale = unitScale;
		this.tileWidth = tileWidth;
		this.tileHeight = tileHeight;
	}

	/** creates a new {@link MyBox2DMapObjectParser} using the given {@link Aliases} and {@link #unitScale} and sets {@link #ignoreMapUnitScale} to true
	 *  @param aliases the {@link #aliases} to use
	 *  @param unitScale the {@link #unitScale} to use */
	public MyBox2DMapObjectParser(Aliases aliases, float unitScale) {
		this.aliases = aliases;
		this.unitScale = unitScale;
	}

	/** creates a new {@link MyBox2DMapObjectParser} using the given {@link Listener} and {@link #unitScale} and sets {@link #ignoreMapUnitScale} to true
	 *  @param listener the {@link #listener} to use
	 *  @param unitScale the {@link #unitScale} to use */
	public MyBox2DMapObjectParser(Listener listener, float unitScale) {
		this.listener = listener;
		this.unitScale = unitScale;
	}

	/** creates a new {@link MyBox2DMapObjectParser} using the given {@link Aliases}, {@link Listener} and {@link #unitScale} and sets {@link #ignoreMapUnitScale} to true
	 *  @param aliases the {@link #aliases} to use
	 *  @param listener the {@link #listener} to use
	 *  @param unitScale the {@link #unitScale} to use */
	public MyBox2DMapObjectParser(Aliases aliases, Listener listener, float unitScale) {
		this.aliases = aliases;
		this.listener = listener;
		this.unitScale = unitScale;
	}

	/** creates a new {@link MyBox2DMapObjectParser} with the given parameters and sets {@link #ignoreMapUnitScale} to true
	 *  @param aliases the {@link #aliases} to use
	 *  @param unitScale the {@link #unitScale unitScale} to use
	 *  @param tileWidth the {@link #tileWidth} to use
	 *  @param tileHeight the {@link #tileHeight} to use */
	public MyBox2DMapObjectParser(Aliases aliases, float unitScale, float tileWidth, float tileHeight) {
		this.aliases = aliases;
		this.unitScale = unitScale;
	 ...
	 *  @param tileWidth the {@link #tileWidth} to use
	 *  @param tileHeight the {@link #tileHeight} to use */
	public MyBox2DMapObjectParser(Listener listener, float unitScale, float tileWidth, float tileHeight) {
		this.listener = listener;
		this.unitScale = unitScale;
		ignoreMapUnitScale = true;
		this.tileWidth = tileWidth;
	 ...
	 *  @param tileWidth the {@link #tileWidth} to use
	 *  @param tileHeight the {@link #tileHeight} to use */
	public MyBox2DMapObjectParser(Listener listener, Aliases aliases, float unitScale, float tileWidth, float tileHeight) {
		this.aliases = aliases;
		this.listener = listener;
		this.unitScale = unitScale;
		ignoreMapUnitScale = true;
	...
	public Body createBody(World world, MapObject mapObject) {
		...
		bodies_id.put(mapObject.getProperties().get("id", Integer.class), body);
	...
	public void addArrayToList(Fixture[] arr, ArrayList<Fixture> list) {
		for(Fixture f : arr) {
			list.add(f);
		}
	}
	...
	public ObjectMap<Integer, Body> getBodiesID(){
		return bodies_id;
	}
